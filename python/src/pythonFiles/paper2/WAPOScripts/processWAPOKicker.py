import pandas as pd
import classes.clsRetrievabilityCalculator as rc
import matplotlib.pyplot as plt
import pythonFiles.plotters.csvPlotterGeneral as pltGen
...
def getMainDf(src,docPath, resPath):
    if (src == ''):
        ...
        resMap = rc.DataframeCalculation.calculate_res_map(resPath, 0, 100)

        df = rc.DataframeCalculation.mergeMaps(docMap, resMap)
        docMap = None
        resMap = None
    else:
        df = pd.read_csv(src)
...
def getInput(corpus,exp):
    ...
    mainFolder = r'C:\Users\kkb19103\Desktop' + '\\'
    # resPath += 'AQ-BM25-UI-300K-C100-AX-fbdocs30-fbterms30-b0.75.res'
    resPath = mainFolder + 'WA-BM25-UI-300K-C100-RM3-fbdocs30-fbterms30-b0.75.res'
...
def main(corpus,exp):
    ...
    mainFolder = r'C:\Users\kkb19103\Desktop\My Files 07-08-2019\BiasMeasurementExperiments\2nd Experiment - RM3 VS AX'
    docFile = mainFolder + r'\DocLength Analysis\Doc Length Analysis\Anserini-DocLength\WA-Doclengths.sts'
    resFile =  r'C:\Users\kkb19103\Desktop\WA-BM25-UI-300K-C100-RM3-fbdocs30-fbterms30-b0.75.res'
    stsFile = r'C:\Users\kkb19103\Desktop\WA-RM-30-30.sts'
    stsFile = ''
